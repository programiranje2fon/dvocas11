...
import zadatak1.TekstualniFajloviTest;
import zadatak2.BazaOsobaTest;
import zadatak2.OsobaTest;
...
public class PokreniTestove {
	...
	public static void main(String[] args) {
		runTestsForClass(TekstualniFajloviTest.class);
		runTestsForClass(OsobaTest.class);
		runTestsForClass(BazaOsobaTest.class);
	}
