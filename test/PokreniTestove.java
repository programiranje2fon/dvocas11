...
public class PokreniTestove {
	...
	public static void main(String[] args) {
		...
		pokreniTestoveZaKlasu(zadatak1.TekstualniFajloviTest.class);
		
		pokreniTestoveZaKlasu(zadatak2.OsobaTest.class);
		pokreniTestoveZaKlasu(zadatak2.BazaOsobaTest.class);
	}
